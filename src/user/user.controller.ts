...
export class UserController {
  ...
  @Get("/getOne/:id")
  async getOneUser(@Param("id") id: string): Promise<{ message: string, user: User }> {
    return this.userService.getOneUser(id)
  }
  @Put("/edit/:id")
  async editUser(@Param("id") id: string, @Body() dto: UpdateUserDto): Promise<{ message: string, user: User }> {
