...
import { compareHashPassword, generateHashPassword } from 'src/util/password.service';
...
export class UserService {
    ...
    async register(dto: CreateUserDto): Promise<{ message: string, user: User }> {
        ...
        await sendEmail(dto.email, "message", "You have successfully registered from the site.")
    ...
    async editUser(id: string, dto: UpdateUserDto): Promise<{ message: string, user: User }> {
        try {
