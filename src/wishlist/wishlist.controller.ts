...
export class WishlistController {
  ...
  @Post("/create")
  async createWishlist(@Body() dto: CreateWishlistDto): Promise<{ message: string, wishlist: Wishlist }> {
    return this.wishlistService.createWishlist(dto)
  }
  @Get("/getOne/:id")
  async getOne(@Param("id") id: string): Promise<{ message: string, wishlist: Wishlist }> {
  ...
  @Put("/edit/:id")
  async updateWishlist(@Param("id") id: string, @Body() dto: UpdateWishlistDto): Promise<{ message: string, wishlist: Wishlist }> {
